    ...
    return (
        <button
            ...
            className={cn(
                ...
                isDisabled ? "text-muted" : "text-secondary hover:bg-surfacehover cursor-pointer"
            )}
        >
        ...
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className={cn(
                    ...
                    isOpen ? "bg-surfacehover" : "bg-surface/50 hover:bg-surfacehover"
                )}
            ...
            {isOpen && (
                <>
                    ...
                    <div className="absolute top-full left-0 mt-1 bg-surface border border-border rounded shadow-lg z-50 min-w-[280px]">
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-3 pt-1 pb-1 text-secondary hover:bg-surfacehover cursor-pointer transition-colors text-left"
                        >
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-3 pt-1 pb-2 text-secondary hover:bg-surfacehover cursor-pointer transition-colors text-left"
                        >
