        ...
        <div className="p-2 border-b border-border">
            <div className="flex gap-2 overflow-x-auto pb-1">
                {droppedFiles.map((file) => (
                    <div key={file.id} className="relative bg-surfacehover rounded-lg p-2 min-w-20 flex-shrink-0 group">
                        <button
                        ...
                        <div className="flex flex-col items-center text-center">
                            {file.previewUrl ? (
                                ...
                                <div className="w-12 h-12 mb-1 flex items-center justify-center bg-surfacehover rounded">
                                    <i
                            ...
                            <div className="text-[10px] text-secondary truncate w-full max-w-16" title={file.name}>
                                {file.name}
                            </div>
